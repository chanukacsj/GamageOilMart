...
public class SpareFormController {
    ...
    private void loadAllSpareParts() {
        ...
        try {
            ArrayList<MaterialDetailsDTO> all = materialDetailBO.loadAllByCategory("Spare Parts");
    ...
    void btnSaveOnAction(ActionEvent event) {
        ...
        try {
            if (materialDetailBO.save(dto)) {
                new Alert(Alert.AlertType.INFORMATION, "Spare Part Saved!").show();
                loadAllSpareParts();
                clearFields();
                loadNextId();
            }
    ...
    void btnDeleteOnAction(ActionEvent event) {
        ...
        Alert c = new Alert(Alert.AlertType.CONFIRMATION, "Delete this Spare Part?", ButtonType.OK, ButtonType.CANCEL);
